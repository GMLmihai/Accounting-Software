...
public class EmployeeMapper {
    ...
    public String getCsvLineEmployee(Employee employee){
  ...
  public List<Employee> getEmployeesList(List<String> stringsEmployees) {
        List<Employee> employees = new ArrayList<>();
        for (String employeeString : stringsEmployees) {
