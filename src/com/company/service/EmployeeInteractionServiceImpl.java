...
public class EmployeeInteractionServiceImpl implements EmployeeInteractionService {
    ...
    @Override
    public Department choseDepartmentAction() {
    ...
    private Department getDepartment() {
        ...
        try {
            ...
            if (depId != Department.IT.getValue() &&
                    depId != Department.HR.getValue() &&
                    depId != Department.SALES.getValue()) {
                throw new InvalidUserInteractionException();
            }
            return depId == Department.IT.getValue() ?
